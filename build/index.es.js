...
var LinkComponentContext = react_10(null);
var CalendarSettingsContext = react_10({});
...
function Cell(_a) {
    ...
    var Link = react_19(LinkComponentContext);
    var _b = react_27(false), isExpanded = _b[0], expand = _b[1];
...
function useEvents(props) {
    var _this = this;
    var _a = react_27(props.events || {}), events = _a[0], setEvents = _a[1];
    var _b = react_27({}), colors = _b[0], setColors = _b[1]; /* calendarName */
    var settings = react_19(CalendarSettingsContext);
    var handleId = react_18(function (calendarId) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var parseColorsFromEvents = react_18(function (eventDict) {
        var c = colors;
...
function Calendar(props) {
    ...
    var _a = react_25(function (state, action) {
    ...
    var calendars = react_24(function () {
        if ('events' in props) {
